    ...
    return (
      <div className="rounded-[2rem] border border-[#D4AF37]/15 bg-white/80 p-10 shadow-[0_35px_90px_rgba(110,78,55,0.1)]">
        ...
        <button
          type="button"
          onClick={() => navigate('/')}
          className="mt-6 inline-flex items-center rounded-3xl bg-[#111111] px-6 py-3 text-sm font-semibold text-white transition hover:bg-[#333333]"
        >
          Back to Projects
        </button>
      </div>
        ...
        >
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <p className="text-sm uppercase tracking-[0.24em] text-[#C8A24A]">Project Case Study</p>
